...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _calculator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./calculator */ \"./src/js/calculator.ts\");\n\nvar calculator = new _calculator__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\ndocument.getElementById(\"sum\").onclick = function () {\n    var numberOne = Number(document.getElementById(\"numberOne\").value);\n    var numberTwo = Number(document.getElementById(\"numberTwo\").value);\n    var result = calculator.sum(numberOne, numberTwo);\n    document.getElementById(\"result\").value = result.toString();\n};\ndocument.getElementById(\"subtract\").onclick = function () {\n    var numberOne = Number(document.getElementById(\"numberOne\").value);\n    var numberTwo = Number(document.getElementById(\"numberTwo\").value);\n    var result = calculator.subtract(numberOne, numberTwo);\n    document.getElementById(\"result\").value = result.toString();\n};\ndocument.getElementById(\"multiply\").onclick = function () {\n    var numberOne = Number(document.getElementById(\"numberOne\").value);\n    var numberTwo = Number(document.getElementById(\"numberTwo\").value);\n    var result = calculator.multiply(numberOne, numberTwo);\n    document.getElementById(\"result\").value = result.toString();\n};\ndocument.getElementById(\"divide\").onclick = function () {\n    var numberOne = Number(document.getElementById(\"numberOne\").value);\n    var numberTwo = Number(document.getElementById(\"numberTwo\").value);\n    var result = calculator.divide(numberOne, numberTwo);\n    document.getElementById(\"result\").value = result.toString();\n};\n\n\n//# sourceURL=webpack:///./src/js/main.ts?");
